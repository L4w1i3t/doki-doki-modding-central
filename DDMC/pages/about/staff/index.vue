...
<template>
  ...
  <div class="staff">
    <div class="staff-list">
      <div v-for="staffMember in staffMembers" :key="staffMember.id" class="staff-member" :class="{ 'iris-section': staffMember.name === 'IrisCandy' }">
      ...
      return {
        staffMembers: [
          ...
          },
          {
            id: 1,
            name: 'Matsuda Akai',
            position: 'Teacher, Data Manager, Site Manager',
