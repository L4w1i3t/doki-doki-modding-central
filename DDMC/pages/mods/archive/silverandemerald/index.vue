...
<template>
  <title>Silver and Emerald</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/silverandemerald.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/ph6bt0zo5fdyrg5/DokiDokiSilverandEmerald-1.0.0.1.zip/file'
        },
      ]
    }
  }
