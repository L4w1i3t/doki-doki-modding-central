...
<template>
  <title>Never Ending Tomorrow</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/neverendingtomorrow.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/aopuo0j7sn06j5g/Never_Ending_Tomorrow-0.4.0-Mod.zip/file'
        },
      ]
    }
  }
