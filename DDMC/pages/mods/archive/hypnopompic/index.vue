...
<template>
  <title>Hypnopompic</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/hypnopompic.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/8xnn4akrokx1g2d/hypnopompic.zip/file'
        },
      ]
    }
  }
