...
<template>
  <title>Midnight Date</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/midnight_date.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/yxkqbv4q28bcjo7/DDMidnightDate-3.0.1-Renpy7Mod.zip/file'
        },
      ]
    }
  }
