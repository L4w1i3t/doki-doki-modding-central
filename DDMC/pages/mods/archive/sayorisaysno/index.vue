...
<template>
  <title>Sayori Says No To Suicide, a PSA</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/sayorisaysno.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/yxv8rdnpb2olu9f/Sayori_says_no_to_suicide_%25281.1%2529.zip/file' 
        },
      ]
    }
  }
