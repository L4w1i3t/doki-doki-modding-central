...
<template>
  <title>Monika Before Story</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/monikabeforestory.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/zfwk9dua2mds8yw/Monika_Before_Story_%2528Full_Release_v1.2%2529-3-1-2.zip/file'
        },
      ]
    }
  }
