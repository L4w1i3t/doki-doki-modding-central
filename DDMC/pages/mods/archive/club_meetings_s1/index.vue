...
<template>
  <title>Club Meetings (Season 1)</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/club_meetings_season1.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/5k179qdjofwj4fx/Club_Meetings_Season1.zip/file'
        },
      ]
    }
  }
