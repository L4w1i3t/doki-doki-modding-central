  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Version 1.0',
          url: 'https://www.mediafire.com/file_premium/cg5ofms8b1e5xgr/DDEM-1.0.0-Mod.zip/file'
        },
        {
          text: 'Latest Version',
          url: 'https://www.mediafire.com/file_premium/ifpb81hp6gppezf/Exit_Music_1.2.zip/file'
        },
      ]
    }
  }
