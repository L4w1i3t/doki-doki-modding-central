...
<template>
  ...
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/celebration.jpg" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
...
export default {
  data() {
    return {
      ...
      description: 'Monika attempts to disable any mods from being playable but messes up, leading to multiple features from various DDLC mods breaking into the game. This mod is a celebration of the large modding community for this game.',
     

      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/v7y9pt9jmn4j1ro/DDMC_Celebration%2521_%2528v1.2%2529.zip/file'
        },
      ]
    }
  }
