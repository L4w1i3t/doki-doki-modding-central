...
<template>
  <title>Doki Doki: Your Girlfriend Really Loves You!</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/girl_really_loves_you.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/8564t9oz433wf5n/DDDG-3.0.1-Renpy7Mod.zip/file'
        },
      ]
    }
  }
