...
<template>
  <title>Club Meetings (Season 3)</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/club_meetings_season3.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/p5vq01zuc7lubmi/club_meetings_season3.webp/file'
        },
      ]
    }
  }
