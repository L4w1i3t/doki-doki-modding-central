<template>
  <title>Doki Doki: Christmas Time</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/christmastime.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/qpej43x7sbey3ck/DDCT-3.0.1-Renpy7Mod.zip/file'
        },
      ]
    }
  }
