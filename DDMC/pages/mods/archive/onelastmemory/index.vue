...
<template>
  <title>One Last Memory</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/onelastmemory.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/v0a4j1pv0rheu5r/One_Last_Memory.zip/file'
        },
      ]
    }
  }
