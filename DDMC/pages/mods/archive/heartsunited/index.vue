...
<template>
  <title>Hearts United</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/heartsunited.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Chapter 1',
          url: 'https://www.mediafire.com/file_premium/slfttda9v9965lu/Our_Hearts_United_%25285th_Anniversary%2529_Chapter_1.zip/file'
        },
      ]
    }
  }
