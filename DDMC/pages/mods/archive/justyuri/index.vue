...
<template>
  <title>Just Yuri</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/justyuri.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Version 1.9.1',
          url: 'https://www.mediafire.com/file_premium/shp0w3zont9cxgu/JustYuri-Beta-1.9.1-pc.zip/file'
        },
      ]
    }
  }
