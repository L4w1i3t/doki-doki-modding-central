...
<template>
  <title>MC Laments His Existence</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/mclaments.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/lyymtuksxc9fmxo/DDLC_MC-1.0-Mod.zip/file'
        },
      ]
    }
  }
