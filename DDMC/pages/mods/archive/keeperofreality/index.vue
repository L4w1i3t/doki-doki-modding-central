...
<template>
  <title>Keeper of Reality (Act One)</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/keeperofreality.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/1ards6xngh8aj15/KeeperofReality1.2-Mod.zip/file'
        },
      ]
    }
  }
