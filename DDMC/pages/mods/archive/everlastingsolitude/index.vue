...
export default {
  data() {
    return {
      ...
      links: [
        {
          text: 'Brazilian PR Ver.',
          url: 'https://www.mediafire.com/file_premium/iw9en9257hxkojx/Doki_Doki_Eterna_Solid%25C3%25A3o.zip/file'
        },
        {
          text: 'English Translated Ver.',
          url: 'https://www.mediafire.com/file_premium/kt3y3bvfoydrd3s/Doki_Doki_Everlasting_Solitude_English_Translated.zip/file'
        },
      ]
    }
  }
