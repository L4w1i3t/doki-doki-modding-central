...
<template>
  <title>Meme Club 2</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/memeclub2.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/2m41oiaei45g2bu/DokiDokiMemeClubPart2.zip/file'
        },
      ]
    }
  }
