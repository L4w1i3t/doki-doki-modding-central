...
<template>
  <title>Yuri's New Toy</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/yurisnewtoy.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/2xm8wxitb4td7xq/Yuri%2527s_New_Toy_version_1.2.zip/file'
        },
      ]
    }
  }
