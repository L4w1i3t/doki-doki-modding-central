...
<template>
  <title>Tsundere Ghosts</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/ghosts.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/ad8hmg8lknjcxc6/TsunGhosts-4.0.1-Py2-Renpy7Mod.zip/file'
        },
      ]
    }
  }
