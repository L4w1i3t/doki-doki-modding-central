...
<template>
  <title>Disappearance of the Literature Club</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/disapperance.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/eve0xiiqo4c4jqn/DotLC-Mod.zip/file'
        },
      ]
    }
  }
