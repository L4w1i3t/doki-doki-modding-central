...
<template>
  <title>Ultimate Combo</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/ultimatecombo.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/tqvtan7p0cu9xtg/DDUC.zip/file'
        },
      ]
    }
  }
