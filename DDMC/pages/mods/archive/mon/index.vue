...
<template>
  <title>Memories of Nothing</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/mon.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/aa7tox5f5krbwl8/MoN-Mod.zip/file'
        },
      ]
    }
  }
