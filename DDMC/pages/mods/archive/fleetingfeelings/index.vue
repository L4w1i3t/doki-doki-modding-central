...
<template>
  ...
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/fleetingfeelings.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/tvsp935bf42fxme/FleetingFeelings-Mod.zip/file'
        },
      ]
    }
  }
