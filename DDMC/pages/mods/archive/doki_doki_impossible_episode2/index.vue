<template>
  <title>Doki Doki Impossible (Episode 1) </title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/doki_doki_impossible_episode2.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
...
export default {
  data() {
    return {
      title: 'Doki Doki Impossible (Episode 2)',
      authors: 'MaksonJolt',
      contributors: 'Submitted By: Tune Eternal',
      description: 'Good day to you, agent. Our story has the second episode now.',
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/zhiqkm3t4z53qy2/Doki_Doki_Impossible_-_Episode_2_%255BUPDATED%255D.zip/file'
        },
      ]
    }
  }
