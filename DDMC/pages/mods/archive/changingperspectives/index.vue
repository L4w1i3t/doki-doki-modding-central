...
<template>
  ...
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/ChangingPerspectives.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/sqp8wne766ndcsr/dokidokichangingperspectives.rpa/file'
        },
      ]
    }
  }
