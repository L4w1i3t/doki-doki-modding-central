...
<template>
  <title>The Haunting of Monika After Story</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/mashaunt.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/ieqev4qwww2h12j/The_Haunting_of_Monika_After_Story_-_Release-20240403T205308Z-001.zip/file'
        },
      ]
    }
  }
