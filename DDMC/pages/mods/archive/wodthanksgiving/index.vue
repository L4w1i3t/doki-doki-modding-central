...
<template>
  <title>World of Dreams: Thanksgiving Special </title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/wodthanksgiving.png" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/by0ffklz2x5ki0p/WOD_Thanksgiving_Special.zip/file'
        },
      ]
    }
  }
