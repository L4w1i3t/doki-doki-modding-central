<template>
  ...
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/doki_doki_impossible_episode1.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Version 1.2.0',
          url: 'https://www.mediafire.com/file_premium/ywp36eshuu0mnt0/Doki_Doki_Impossible_Episode_1_%25281.2.0_Updated%2529.zip/file'
        },
      ]
    }
  }
