...
<template>
  <title>Club Meetings (Season 2)</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/club_meetings_season2.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/57ofd6z7gq2yb5t/Club_Meetings_S2Collection.zip/file'
        },
      ]
    }
  }
