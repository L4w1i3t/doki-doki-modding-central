...
<template>
  <title>Total Fold</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/totalfold.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/v0w7x76c5jczop2/Total_Fold-Mod.zip/file'
        }
      ]
    }
  }
