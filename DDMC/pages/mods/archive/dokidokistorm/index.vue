<template>
  <title>Doki Doki Storm </title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/dokidokistorm.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/a35plehrpajwumc/Doki_Doki_Storm_version_1.3.zip/file'
        },
      ]
    }
  }
