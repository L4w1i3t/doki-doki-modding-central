...
<template>
  <title>The First DDLC+ Mod</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/firstddlcplusmod.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/eqxbp5uin730412/FirstDDLCPlusMod%2521.zip/file'
        },
      ]
    }
  }
