...
<template>
  <title>Just Kotonoha!</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/justkoto.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/y21j9dqol07tjxt/JustKotonoha-1.0-Renpy7Mod.zip/file'
        },
      ]
    }
  }
