<template>
  <title>Doki Doki Ordo Literato </title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/dokidokiordoliterato.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/n6ee3zoqgc8ydmg/DokiHammer_Prologue_OrdoLiterato.rar/file'
        },
      ]
    }
  }
