...
<template>
  <title>Natsuki Rants About Mods & Community</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/natsukirants.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/hsvawn50amqn0ao/NRADMC.zip/file'
        },
      ]
    }
  }
