...
<template>
  <title>My Cloudy Reality!</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/cloudyreality.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Windows/Mac',
          url: 'https://www.mediafire.com/file_premium/yfm67v2wwww6wqw/My_Cloudy_Reality_1.0_Download-20240507T124723Z-001.zip/file'
        },
      ]
    }
  }
