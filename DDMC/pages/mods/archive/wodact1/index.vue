...
<template>
  <title>World of Dream - Act 1 </title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/wodact1.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/75sibbk6do5l6o8/World_of_Dreams__Act_1-20240410T023030Z-001.zip/file'
        },
      ]
    }
  }
