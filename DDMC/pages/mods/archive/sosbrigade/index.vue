...
<template>
  <title>Doki Doki SOS Brigade</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/sosbrigade.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/5fw5l3gcanq8fxt/DokiDokiSOSBrigade-4.2.2-Py2-Renpy7Mod.zip/file'
        },
      ]
    }
  }
