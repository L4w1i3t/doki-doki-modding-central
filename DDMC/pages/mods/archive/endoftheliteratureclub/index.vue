<template>
  <title>End of the Literature Club</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/endoftheliteratureclub.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/p8p78lxxrhajr72/EOL_1.1.zip/file'
        },
      ]
    }
  }
