...
<template>
  <title>Purist Mod</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/purist.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Version 1.1.1',
          url: 'https://www.mediafire.com/file_premium/rxkxkcc1wt88apo/Purist_Mod_Release_v1.1.1.zip/file'
        },
      ]
    }
  }
