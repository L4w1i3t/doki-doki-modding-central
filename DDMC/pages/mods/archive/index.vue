<template>
  ...
  <div class="title-container">ARCHIVE</div>
  <div class="character-grid">
    <a v-for="mod in paginatedMods" :key="mod.id" :href="`/mods/archive/${mod.route}`" class="character-card">
  ...
  export default {
    ...
    created() {
      axios.get('/data/mods.json').then(response => {
        this.mods = response.data.archive;
