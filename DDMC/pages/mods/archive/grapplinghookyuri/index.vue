  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Windows',
          url: 'https://www.mediafire.com/file_premium/4r732bxkq4i95d3/GHY-4.0.1-Py2-Renpy7Mod_Windows.zip/file'
        },
        {
          text: 'Linux',
          url: 'https://www.mediafire.com/file_premium/771cnef49pp7vhz/GHY-4.0.1-Py2-Renpy7Mod-LINUX.zip/file'
        },
      ]
    }
  }
