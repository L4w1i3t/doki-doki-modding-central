...
<template>
  <title>Monika Gets An Anal Probe</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/monika_anal_probe.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/vpiefiuhqvohb5d/MGAAP-1.0-pc.zip/file'
        },
      ]
    }
  }
