...
<template>
  <title>Purple Troubles</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/purpletroubles.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/gcbc4f26m6rd8hr/DDPT-1.0-Mod.zip/file'
        },
      ]
    }
  }
