...
<template>
  <title>Natsuki Becomes The President Of The United States</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/presidentnat.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/6fs9y2r2inws5jr/NBTPOTUSA-69.420-Renpy7Mod.zip/file'
        },
      ]
    }
  }
