...
<template>
  ...
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/remembering.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
      ...
      links: [
        {
          ...
          url: 'https://www.mediafire.com/file_premium/wz3tw453o9i1py8/gov.sdc.remembering_eac-release.apk/file'
        },
      ]
    }
  }
