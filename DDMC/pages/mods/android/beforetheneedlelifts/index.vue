...
<template>
  <title>Before the Needle Lifts</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/beforetheneedlelifts.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/jokp05mi5kgf7rz/Before_the_Needle_Lifts_Android_Port.apk/file'
        },
      ]
    }
  }
