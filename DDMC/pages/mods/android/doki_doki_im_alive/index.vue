...
<template>
  <title>Doki Doki I'm Alive</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/imalive.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
