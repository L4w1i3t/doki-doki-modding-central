...
<template>
  <title>My Doki Doki SNAFU</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/snafu.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
      ...
      links: [
        {
          ...
          url: 'https://www.mediafire.com/file_premium/w07vv8wp0zqljkd/MyDokiDokiSNAFU-1.1.6-f.apk/file'
        },
      ]
    }
  }
