...
<template>
  <title>A Date With Monika</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/datewithmonika.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
      ...
      links: [
        {
          ...
          url: 'https://www.mediafire.com/file_premium/if25ingcwbrzknr/A_Date_with_Monika.apk/file'
        },
      ]
    }
  }
