...
<template>
  <title>Deceptive Hearts</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/deceptivehearts.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
...
export default {
  data() {
    return {
      ...
      links: [
        {
          text: 'Android Downloadd',
          url: 'https://www.mediafire.com/file_premium/4ouxmpu2hxwl8yh/Deceptive_Hearts_Android_Port.apk/file'
        },
      ]
    }
  }
