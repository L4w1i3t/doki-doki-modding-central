...
<template>
  <title>A Date With Natsuki</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/datewithnatsuki.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
      ...
      links: [
        {
          ...
          url: 'https://www.mediafire.com/file_premium/thngv03qkr9i070/A_Date_with_Natsuki.apk/file'
        },
      ]
    }
  }
