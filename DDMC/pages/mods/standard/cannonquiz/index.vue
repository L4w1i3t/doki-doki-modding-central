...
<template>
  <title>Canon Quiz</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/cannonquiz.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/2rora1jdyokcs3m/DDCQ.zip/file'
        },
      ]
    }
  }
