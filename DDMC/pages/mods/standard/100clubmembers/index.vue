...
<template>
  <title>100 Club Members (Season 1)</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/100clubmembers.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/ovfunms7fwuo669/100ClubMembersMod-Season1-Renpy7Mod.zip/file'
        },
      ]
    }
  }
