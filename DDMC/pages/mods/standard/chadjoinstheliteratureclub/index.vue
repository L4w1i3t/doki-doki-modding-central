...
<template>
  <title>Chad Joins the Literature Club</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/chadjoinstheliteratueclub.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/eq9aigtpptynzbv/DDLC-Can-he-write-his-way-into-your-heart-Renpy7Mod-v1.01.zip/file'
        }
      ]
    }
  }
