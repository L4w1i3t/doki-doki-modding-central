...
<template>
  <title>Neuro-sama joins the Literature Club!</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/neurosama.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/rqudjfqrrkty2zs/NeuroDDLCDemo-0.1.0-Renpy8-DDLCMod.zip/file'
        },
      ]
    }
  }
