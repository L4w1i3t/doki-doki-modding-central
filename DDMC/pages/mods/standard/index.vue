<template>
  ...
  <div class="title-container">MODS FOR PC (STANDARD)</div>
  <div class="character-grid">
    <a v-for="mod in paginatedMods" :key="mod.id" :href="`/mods/standard/${mod.route}`" class="character-card">
  ...
  export default {
    ...
    created() {
      axios.get('/data/mods.json').then(response => {
        this.mods = response.data.standard;
