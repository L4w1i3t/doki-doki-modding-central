...
<template>
  <title>The Dark Raincloud</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/thedarkrainclouds.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/qa7wsioxcv5rgxo/DokiDokiDarkRainclouds-Py2-4.2.2-Py2-Renpy7Mod.zip/file'
        },
      ]
    }
  }
