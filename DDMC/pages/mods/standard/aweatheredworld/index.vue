...
<template>
  <title>A Weathered World (Remake)</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/aweatheredworld.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/2ilq0xtbnw6cyr8/A_Weathered_World_1.0.zip/file'
        },
      ]
    }
  }
