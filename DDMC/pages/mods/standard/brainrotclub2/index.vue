...
<template>
  <title>Doki Doki Brainrot Club 2: Redux/Remaster</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/brainrotclub2.jpg" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/za9u61ueguccnl8/DDLCBRAINROTREDUXREMASTER2-1-Renpy7Mod.zip/file'
        },
      ]
    }
  }
