...
<template>
  <title>Monika Enters the Real World</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/monikaenterstherealworld.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/6yfyyo1ge6k4iu6/Monika_enters_the_real_world.zip/file'
        },
      ]
    }
  }
