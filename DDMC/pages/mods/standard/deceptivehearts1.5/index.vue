...
<template>
  <title>Deceptive Hearts 1.5</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/deceptivehearts15.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/kfi88skg1xf0aqa/DH15-1.5-Renpy8-DDLCMod.zip/file'
        },
      ]
    }
  }
