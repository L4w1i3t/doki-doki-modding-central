...
<template>
  ...
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/herstory.png" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/yohzb43sg0uc8an/Her_Story_%2528v1.1.0%2529_%25281%2529.zip/file'
        },
      ]
    }
  }
