...
<template>
  <title>Doki Doki Undercurrents Demo</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/undercurrents.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
...
export default {
  data() {
    return {
      ...
      links: [
        {
          text: 'Download Demo 2.1.0',
          url: 'https://www.mediafire.com/file_premium/c5r5f68qtsezfzi/DokiDokiUndercurrentsD2Sleepover-Renpy8-DDLCMod.zip/file'
        },
      ]
    }
  }
