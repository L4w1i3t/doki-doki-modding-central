...
<template>
  <title>Afternoon Demo</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/afternoon.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
...
export default {
  data() {
    return {
      ...
      authors: 'By Süleyman Aydın',
      contributors: 'Submitted By: Tune Eternal',
      description: "He began to come to his senses in the borderless world of the dear friend. Guide him, he needs you very much. Go as far as you can and end this cursed cycle. Who knows... maybe this time everything will be fine.",
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/ueup45wzcn4ruru/Afternoon_Demo.rar/file'
        },
      ]
    }
  }
