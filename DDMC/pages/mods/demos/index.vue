<template>
  <title>Mods - Demos || Doki Doki Modding Central</title>
  <div class="title-container">MOD DEMOS</div>
  <div class="character-grid">
    <a v-for="mod in paginatedMods" :key="mod.id" :href="`/mods/demos/${mod.route}`" class="character-card">
