...
<template>
  <title>Natsuki's Expanded Story</title>
    <div>
      <div class="preview-image">
        <img src="/assets/mod_prevs/natsukis_expanded_story.webp" alt="Preview Image">
      </div>
      <div class="title-box">
        <h1>{{ title }}</h1>
    ...
    data() {
      return {
        ...
        links: [
          {
            text: 'Download Demo',
            url: 'https://www.mediafire.com/file_premium/cmkbo6riiop8qls/NES1.0.zip/file', 
          },
        ]
      }
    }
