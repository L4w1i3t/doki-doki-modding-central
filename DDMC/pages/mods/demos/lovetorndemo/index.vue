...
<template>
  <title>Doki Doki Love Torn (Demo)</title>
    <div>
      <div class="preview-image">
        <img src="/assets/mod_prevs/love_torn.webp" alt="Preview Image">
      </div>
      <div class="title-box">
        <h1>{{ title }}</h1>
    ...
    data() {
      return {
        ...
        links: [
          {
            text: 'Version V1',
            url: 'https://www.mediafire.com/file_premium/54h60a0h9q1loax/DDLoveTorn-3.0.0-Mod.zip/file'
          },
          {
            text: 'Version V2',
            url: 'https://www.mediafire.com/file_premium/1j19a2taoe7w59n/DDLoveTorn-3.0.1-Renpy7Mod.zip/file'
          },
        ]
      }
    }
