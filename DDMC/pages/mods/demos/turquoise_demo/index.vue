...
<template>
  <title>Turquoise Demo</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/turquoise.webp" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Standard',
          url: 'https://www.mediafire.com/file_premium/urkubfq7t3gvvg5/Turquoise_demo_1.3.zip/file'
        },
      ]
    }
  }
