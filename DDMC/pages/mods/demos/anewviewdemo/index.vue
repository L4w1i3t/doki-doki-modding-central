...
<template>
  <title>A New View(Demo)</title>
  <div>
    <div class="preview-image">
      <img src="/assets/mod_prevs/new_view.png" alt="Preview Image">
    </div>
    <div class="title-box">
      <h1>{{ title }}</h1>
  ...
  data() {
    return {
      ...
      links: [
        {
          text: 'Download Demo',
          url: 'https://www.mediafire.com/file_premium/mr1sochv00v37i6/DDHaruna-3.0.1-Renpy7Mod.zip/file'
        },
      ]
    }
  }
