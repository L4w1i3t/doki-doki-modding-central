<template>
  <title>DokiFan's Birthday Surprise</title>
  <div>
    <div class="preview-image">
    <iframe 
      class="video" 
      src="https://www.youtube.com/embed/T_UhSfKJ1Lc?si=dsYU1svVFA9vdntX" 
      frameborder="0" 
...
export default {
  data() {
    return {
      title: 'DokiFan’s Birthday Surprise ',
      authors: 'By MarioDokiFan4ever',
      contributors: 'Submitted By: MarioDokiFan4ever',
      description: 'It’s DokiFan’s birthday, however, all his friends are acting as if they don’t remember his birthday. Could they really have forgotten or is it just a ruse?',
      links: [
        {
          text: '1.0',
