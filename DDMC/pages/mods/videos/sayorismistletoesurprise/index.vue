<template>
  <title>Sayori's Mistletoe Surprise</title>
  <div>
    <div class="preview-image">
    <iframe 
      class="video" 
      src="https://www.youtube.com/embed/gw3EPUAmp_g?si=Rptq7JdvKCsrrX7N" 
      frameborder="0" 
...
export default {
  data() {
    return {
      title: "Sayori’s Mistletoe Surprise",
      authors: 'By MarioDokiFan4ever',
      contributors: 'Submitted By: MarioDokiFan4ever',
      description: 'It’s Christmas Eve, and DokiFan wants to hang out with his amazing girlfriend while she has something planned of her own. Just what could the bun be up to?',
      links: [
        {
          text: '1.0',
