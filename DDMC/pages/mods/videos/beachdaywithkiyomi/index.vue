<template>
  ...
  <div>
    ...
    <iframe 
      class="video" 
      src="https://www.youtube.com/embed/hfcId7tv9Ko?si=Myvo9cjKwjpS23os" 
      frameborder="0" 
...
export default {
  data() {
    return {
      ...
      description: 'Kiyomi wants to spend some quality time with DokiFan at the beach. Wonder what will happen between them.',
      links: [
        {
          text: '1.0',
