<template>
  <title>Hang Out with Kotonoha</title>
  <div>
    <div class="preview-image">
    <iframe 
      class="video" 
      src="https://www.youtube.com/embed/Mdp_NoPM3jE?si=EwqcoCbt0xdkSZqb" 
      frameborder="0" 
...
export default {
  data() {
    return {
      title: 'Hang Out with Kotonoha',
      authors: 'By MarioDokiFan4ever',
      contributors: 'Submitted By: MarioDokiFan4ever',
      description: 'It’s been too long since Koto has seen DokiFan, so she decides to ask him out on a hang out to catch up on things.',
      links: [
        {
          text: '1.0',
