<template>
  <title>Beach Day With Kiyomi</title>
  <div>
    <div class="preview-image">
    <iframe 
      class="video" 
      src="https://www.youtube.com/embed/-wUxszG58UY?si=ITGf4SnwDkdH21hz" 
      frameborder="0" 
...
export default {
  data() {
    return {
      title: 'A Month With Natsuki',
      authors: 'By TheBike',
      contributors: 'Submitted By: JNT',
      description: 'You spend a month with Natsuki. Does it turn out well?.',
      links: [
        {
          text: '1.0',
