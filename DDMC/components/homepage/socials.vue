<template>
  <header class="header" :style="{ backgroundImage: 'url(' + currentImageUrl + ')' }">
    ...
    <nav>
        ...
        <a :href="ddlcLink" target="_blank">
          <img src="/assets/gui/ddlclogo.webp" class="ddlc-sprite" alt="DDLC" @mouseenter="playHoverSound">
        </a>
        <a :href="plusLink" target="_blank">
          <img src="/assets/gui/pluslogo.webp" class="plus-sprite" alt="Plus" @mouseenter="playHoverSound">
        </a>
...
export default {
  data() {
    return {
      ...
      ddlcLink: 'https://ddlc.moe/',
      plusLink: 'https://ddlc.plus/'
    };
  },
  computed: {
    currentImageUrl() {
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------- */
  ...
  @media (min-width: 1024px) {
    ...
    .reddit-sprite:hover, .discord-sprite:hover, .evil-reddit-sprite:hover, .ddlc-sprite:hover, .plus-sprite:hover {
        opacity: 0.8;
